...
export class CategoryController {
  ...
  async findAll(@Query() query: PaginatedRequest) {
    ...
    const result = plainToInstance(Category, categories, {
  ...
  async findSubCategories(@Query() query: PaginatedRequest) {
    ...
    const result = plainToInstance(SubCategory, subcategories, {
      excludeExtraneousValues: true,
    });
    return new PaginatedResponse(result, { meta: { total, ...query } });
  }
  ...
  async createCategory(
    ...
    const result = plainToInstance(Category, category, {
      excludeExtraneousValues: true,
    });
  ...
  async createSubCategory(
    ...
    const result = plainToInstance(SubCategory, subCategory, {
      excludeExtraneousValues: true,
    });
