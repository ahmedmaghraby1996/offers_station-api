...
export class BanarController {
  constructor(private readonly banarService: BanarService) {}
  ...
  async createBanar(
    ...
    const result = plainToInstance(BannerResponse, banner, {
  ...
  @Get('/Popup/guest')
  async getGuestPopup(): Promise<ActionResponse<BannerResponse>> {
